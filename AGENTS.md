...
Stack: Next.js 14 App Router · TypeScript strict · Tailwind CSS · Firebase (futuro)
Fase atual: **FASE 1 concluída** | Próxima: **FASE 2 — Painel Admin**
...
| FASE 2 | ⏳ Pendente | Painel admin — Firebase Auth + CRUD |
